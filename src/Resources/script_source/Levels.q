...
SCRIPT Load_alc_thps4 
	load_level Level_alc_thps4 
ENDSCRIPT

Level_alc_thps4 = { 
	structure_name = Level_alc_thps4 
	load_script = Load_alc_thps4 
	name = "Alcatraz" 
	loading_screen = "loadscrn_generic" 
	loading_time = 9.50000000000 
	pre = "alc_thps4.pre" 
	scnpre = "alc_thps4scn.pre" 
	level = "alc_thps4" 
	sky = "alc_thps4_sky" 
	qb = "levels\\alc_thps4\\alc_thps4.qb" 
	colpre = "alc_thps4col.pre" 
	pedpre = "NJped.pre" 
	level_qb = "levels\\alc_thps4\\alc_thps4_scripts.qb" 
	startup_script = alc_thps4_Startup 
	goals_script = alc_thps4_goals 
	setup_script = alc_thps4_setup 
	default_stats = 5 
	level_number = LevelNum_Default 
	ambient_red = 89 
	ambient_green = 79 
